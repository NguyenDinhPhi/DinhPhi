...
<html lang="vi">
   <head>
      ...
      <link rel="shortcut icon" href="https://phimmoichills.net/favicon.ico" type="image/x-icon" />
      ...
      <style>#header .site-title {background: url(https://phimmoichills.net/dev/images/logo.png) no-repeat top left;background-size: contain;text-indent: -9999px;}</style>
   </head>
                     ...
                     <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                        ...
                        <li class="mega dropdown">
                           ...
                           <ul role="menu" class=" dropdown-menu">
                              <li><a title="Phim 2020" href="danhmuc.php">Năm 2022</a></li>
                              <li><a title="Phim 2020" href="danhmuc.php">Năm 2021</a></li>
                              <li><a title="Phim 2020" href="danhmuc.php">Năm 2020</a></li>
                  ...
                  <div id="halim-advanced-widget-4-ajax-box" class="halim_box">
                     <article class="col-md-2 col-sm-4 col-xs-6 thumb grid-item post-38424">
                        <div class="halim-item">
                           <a class="halim-thumb" href="chitiet.php" title="Miệng Bự Vietsub">
                              <figure><img class="lazy img-responsive" src="https://dongphimzz.top/wp-content/uploads/2022/08/spl-tvhayorg-34380-300x450.jpg" alt="Miệng Bự Vietsub" title="Miệng Bự Vietsub"></figure>
                              <span class="status">HD</span><span class="episode"><i class="fa fa-play" aria-hidden="true"></i>Vietsub</span> 
                              <div class="icon_overlay"></div>
                              <div class="halim-post-title-box">
                                 <div class="halim-post-title ">
                                    <p class="entry-title">Miệng Bự Vietsub</p>
                                    <p class="original_title">Big Mouth Vietsub </p>
                                 </div>
                              </div>
                           </a>
                        </div>
...
>>>>>>> 0d85aef476e2abb73c193b2216d17efb023992b6
      </div>
      <div class="clearfix"></div>
